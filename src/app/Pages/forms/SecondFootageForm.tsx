...
import { defaultJustification } from "../../../features/generateReport/generateReportUtils/newConstants";
    ...
    useEffect(() => {
        ...
        if (report.generalInformation.justification === "") {
            ...
            if (reportType === "LA") {
                ...
                const station = report.incidentInformation.turnoutFrom || "";
                value = defaultJustification.LR(appliance, station, boundary);
            }
                ...
                >
                    ...
                    <Box
                        sx={{
                            ...
                            border: `1px solid ${totalTime.totalSeconds / 60 >
                                Number(report.generalInformation.boundary)
